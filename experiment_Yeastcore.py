...
from experiment_TEST_sets import prepare_YEAST_token_and_handfeat_new
...
def eval_model(pairs_, labels_, savedir_):
...
if __name__ == "__main__":
    ...
    for lg in range(30, 31, 2):
        ...
        eval_model(id_pairs, labels, savedir_=name_APAACplus)
